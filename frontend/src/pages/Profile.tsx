...
import { Edit, Save, X, Plus, Camera, Users } from "lucide-react";
    ...
    <Layout contentClassName="container mx-auto px-4 py-6 max-w-4xl">
      ...
      <div className="flex flex-col gap-6">
        ...
        <Card className="shadow-md overflow-hidden">
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 h-32 relative"></div>
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Select activities you're interested in joining
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isEditing ? (
